...
public readonly struct Result<TValue, TError> : IEquatable<Result<TValue, TError>>
{
    ...
    public Task<Result<TValueEx, TError>> MapValue<TValueEx>([NotNull] Func<TValue, Task<TValueEx>> mapper)
    {
        ...
        static async Task<Result<TValueEx, TError>> MapValueCore(Result<TValue, TError> source, Func<TValue, Task<TValueEx>> map) =>
            source._success
...
public static class Result
{
        ...
        [NotNull] Func<TValue, TValueEx> mapper)
    {
        ...
        static async Task<Result<TValueEx, TError>> MapValueCore(Task<Result<TValue, TError>> src, Func<TValue, TValueEx> map) =>
        ...
        [NotNull] Func<TValue, Task<TValueEx>> mapper)
    {
        ...
        static async Task<Result<TValueEx, TError>> MapValueCore(Task<Result<TValue, TError>> src, Func<TValue, Task<TValueEx>> map) =>
        ...
        [NotNull] Func<TError, TErrorEx> mapper)
    {
        ...
        static async Task<Result<TValue, TErrorEx>> MapErrorCore(Task<Result<TValue, TError>> src, Func<TError, TErrorEx> map) =>
        ...
        [NotNull] Func<TValue, Task<Result<TValueEx, TError>>> selector)
    {
        ...
        static async Task<Result<TValueEx, TError>> SelectManyCore(Result<TValue, TError> src, Func<TValue, Task<Result<TValueEx, TError>>> select) =>
            src.IsSuccess
        ...
        [NotNull] Func<TValue, Result<TValueEx, TError>> selector)
    {
        ...
        static async Task<Result<TValueEx, TError>> SelectManyCore(
        ...
        [NotNull] Func<TValue, TValueEx, TValueExEx> projector)
    {
        ...
        static async Task<Result<TValueExEx, TError>> SelectManyCore(
